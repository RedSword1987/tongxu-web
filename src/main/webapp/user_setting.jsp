                            ...
                            <form id="btn_edit_content"   data-parsley-validate class="form-horizontal form-label-left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <input  type="password"    name="updateForm_oldPassword"    id="updateForm_oldPassword" class="form-control col-md-3 col-xs-3" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-2"> 新密码</label>
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <input type="password"  name="updateForm_newPassword"  id="updateForm_newPassword" class="form-control col-md-3 col-xs-3"/>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-2"> 重复新密码</label>
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <input type="password"  name="updateForm_newPasswordRepeat"  id="updateForm_newPasswordRepeat" class="form-control col-md-3 col-xs-3"/>
                                    </div>
                                </div>
