...
!function (a) {
    ...
    function ua(a) {
        for (var b, c = [], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; b = d.exec(a);)b[1] ? c.push(b[1]) : b[2] ? c.push({maybe: ua(b[2])}) : b[3] ? c.push({token: b[3]}) : b[5] && c.push(b[5]);
        return c
    }
    ...
    function Ja(a) {
        var b, c, d, e, f;
        for (b = 0; b < a.length; b++)for (c = a[b], d = 0; d < c.length; d++)for (e = c[d], e.forwardSegs = [], f = b + 1; f < a.length; f++)La(e, a[f], e.forwardSegs)
    }
    ...
    function Na(c, d) {
        ...
        var R, S, T, U, W, X, Y, Z, $ = N.isFetchNeeded, _ = N.fetchEvents, aa = c[0], ba = {}, ca = 0, da = [];
    ...
    function Ra(c) {
        ...
        function g(b, d) {
            ...
            for (e = 0; e < h.length; e++) {
                if (f = h[e].call(H, b, I.clone(), M.clone(), c.timezone, d), f === !0)return;
                if ("object" == typeof f)return void g(f, d)
            }
            var i = b.events;
            if (i)a.isFunction(i) ? (H.pushLoading(), i.call(H, I.clone(), M.clone(), c.timezone, function (a) {
                d(a), H.popLoading()
        ...
        function s(d, e) {
            var f, g, h, i = {};
            if (c.eventDataTransform && (d = c.eventDataTransform(d)), e && e.eventDataTransform && (d = e.eventDataTransform(d)), a.extend(i, d), e && (i.source = e), i._id = d._id || (void 0 === d.id ? "_fc" + Bb++ : d.id + ""), d.className ? "string" == typeof d.className ? i.className = d.className.split(/\s+/) : i.className = d.className : i.className = [], f = d.start || d.date, g = d.end, T(f) && (f = b.duration(f)), T(g) && (g = b.duration(g)), d.dow || b.isDuration(f) || b.isDuration(g))i.start = f ? b.duration(f) : null, i.end = g ? b.duration(g) : null, i._recurring = !0; else {
        ...
        function w(b, c, d) {
            ...
            if (c = c || I, d = d || M, b)if (b._recurring) {
        ...
        var I, M, N = H.reportEvents, O = {events: []}, P = [O], Q = 0, R = 0, S = [];
    ...
    var Ta = a.fullCalendar = {version: "2.7.0", internalApiVersion: 3}, Ua = Ta.views = {};
    ...
    var Xa = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Ya = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];
    Ta.log = function () {
    ...
    var Za, $a, _a, ab = {}.hasOwnProperty, bb = /^\s*\d{4}-\d\d$/, cb = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, db = b.fn, eb = a.extend({}, db);
    Ta.moment = function () {
        return ia(arguments)
    ...
    var nb = mb.extend({
        ...
        setElement: function (a) {
            this.el = a, y(a), this.view.calendar.isTouch ? this.bindDayHandler("touchstart", this.dayTouchStart) : this.bindDayHandler("mousedown", this.dayMousedown), this.bindSegHandlers(), this.bindGlobalHandlers()
        },
    ...
    pb.mixin({
        ...
        handleSegTouchStart: function (a, b) {
            ...
            f && h && (i = this.startSegResize(a, b)), i || !g && !h || (this.clearDragListeners(), c = g ? this.buildSegDragListener(a) : new mb, c._dragStart = function () {
                f || d.selectEvent(e)
        ...
        eventsToSegs: function (b, c) {
            ...
            return a.each(e, function (a, b) {
                ...
                if (Ba(b[0]))for (g = d.invertRanges(g), e = 0; e < g.length; e++)f.push.apply(f, d.eventRangeToSegs(g[e], b[0], c)); else for (e = 0; e < g.length; e++)f.push.apply(f, d.eventRangeToSegs(g[e], b[e], c))
            }), f
        },
        ...
        invertRanges: function (a) {
            ...
            for (a.sort(Ea), b = 0; b < a.length; b++)c = a[b], c.start > h && g.push({
                start: h,
                end: c.start
            }), h = c.end;
    ...
    var sb = Ta.TimeGrid = pb.extend(qb, {
        ...
        renderDates: function () {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new lb({
                els: this.colEls,
                isHorizontal: !0
            }), this.slatCoordCache = new lb({els: this.slatEls, isVertical: !0}), this.renderContentSkeleton()
        },
        renderHtml: function () {
        ...
        computeLabelInterval: function (a) {
            var c, d, e;
            for (c = Jb.length - 1; c >= 0; c--)if (d = b.duration(Jb[c]), e = P(d, a), fa(e) && e > 1)return d;
            return b.duration(a)
        },
        computeEventTimeFormat: function () {
    ...
    sb.mixin({
        ...
        fgSegHtml: function (a, b) {
            var c, d, e, f = this.view, g = a.event, h = f.isEventDraggable(g), i = !b && a.isStart && f.isEventResizableFromStart(g), j = !b && a.isEnd && f.isEventResizableFromEnd(g), k = this.getSegClasses(a, h, i || j), l = ca(this.getSegSkinCss(a));
    ...
    var tb = Ta.View = va.extend(ib, jb, {
        ...
        computeRange: function (a) {
            var b, c, d = M(this.intervalDuration), e = a.clone().startOf(d), f = e.clone().add(this.intervalDuration);
        ...
        getUnitViewSpec: function (b) {
            var c, d, e;
            if (-1 != a.inArray(b, Ya))for (c = this.header.getViewsWithButtons(), a.each(Ta.views, function (a) {
                c.push(a)
            }), d = 0; d < c.length; d++)if (e = this.getViewSpec(c[d]), e && e.singleUnit == b)return e
        },
        buildViewSpec: function (a) {
            for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l;)d = Ua[l], e = h[l], l = null, "function" == typeof d && (d = {"class": d}), d && (i.unshift(d), j.unshift(d.defaults || {}), f = f || d.duration, l = l || d.type), e && (k.unshift(e), f = f || e.duration, l = l || e.type);
    ...
    var xb = {
        buttonText: function (a) {
            return {prev: ba(a.prevText), next: ba(a.nextText), today: ba(a.currentText)}
    ...
    Ua.basic = {"class": Cb}, Ua.basicDay = {type: "basic", duration: {days: 1}}, Ua.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    }, Ua.month = {"class": Eb, duration: {months: 1}, defaults: {fixedWeekCount: !0}};
    ...
    }, Ua.agendaDay = {type: "agenda", duration: {days: 1}}, Ua.agendaWeek = {type: "agenda", duration: {weeks: 1}}, Ta
});