...
var validator = (function () {
            ...
            if (isNaN(parseFloat(a)) && !isFinite(a)) {
                ...
                if (a.length < lengthRange[0]) {
                    ...
                    if (lengthRange[1] && a.length > lengthRange[1]) {
                        ...
                        if (minmax[0] && (a | 0) < minmax[0]) {
                            alertTxt = message.number_min;
                            return false
                        } else {
                            if (minmax[1] && (a | 0) > minmax[1]) {
    ...
    function checkAll($form) {
        ...
        var that = this, submit = true, fieldsToCheck = $form.find(":input").filter("[required=required], .required, .optional").not("[disabled=disabled]");
