!function t(e, i, a) {
    ...
    1: [function (t, e, i) {
        function a(t) {
            var e, i, a, s = t[0] / 255, o = t[1] / 255, n = t[2] / 255, r = Math.min(s, o, n), l = Math.max(s, o, n), h = l - r;
            return l == r ? e = 0 : s == l ? e = (o - n) / h : o == l ? e = 2 + (n - s) / h : n == l && (e = 4 + (s - o) / h), e = Math.min(60 * e, 360), 0 > e && (e += 360), a = (r + l) / 2, i = l == r ? 0 : .5 >= a ? h / (l + r) : h / (2 - l - r), [e, 100 * i, 100 * a]
        }

        function s(t) {
            var e, i, a, s = t[0], o = t[1], n = t[2], r = Math.min(s, o, n), l = Math.max(s, o, n), h = l - r;
            return i = 0 == l ? 0 : h / l * 1e3 / 10, l == r ? e = 0 : s == l ? e = (o - n) / h : o == l ? e = 2 + (n - s) / h : n == l && (e = 4 + (s - o) / h), e = Math.min(60 * e, 360), 0 > e && (e += 360), a = l / 255 * 1e3 / 10, [e, i, a]
        }
        ...
        function c(t) {
            var e, i, a, s = h(t), o = s[0], n = s[1], r = s[2];
        ...
        function d(t) {
            var e, i, a, s, o, n = t[0] / 360, r = t[1] / 100, l = t[2] / 100;
            if (0 == r)return o = 255 * l, [o, o, o];
            i = .5 > l ? l * (1 + r) : l + r - l * r, e = 2 * l - i, s = [0, 0, 0];
            for (var h = 0; 3 > h; h++)a = n + 1 / 3 * -(h - 1), 0 > a && a++, a > 1 && a--, o = 1 > 6 * a ? e + 6 * (i - e) * a : 1 > 2 * a ? i : 2 > 3 * a ? e + (i - e) * (2 / 3 - a) * 6 : e, s[h] = 255 * o;
            return s
        }
        ...
        function x(t) {
            var e = t[0] / 60, i = t[1] / 100, a = t[2] / 100, s = Math.floor(e) % 6, o = e - Math.floor(e), n = 255 * a * (1 - i), r = 255 * a * (1 - i * o), l = 255 * a * (1 - i * (1 - o)), a = 255 * a;
            switch (s) {
                case 0:
                    return [a, l, n];
                case 1:
        ...
        function S(t) {
            var e, i, a, s, o = t[0] / 360, n = t[1] / 100, l = t[2] / 100, h = n + l;
            switch (h > 1 && (n /= h, l /= h), e = Math.floor(6 * o), i = 1 - l, a = 6 * o - e, 0 != (1 & e) && (a = 1 - a), s = n + a * (i - n), e) {
                default:
                case 6:
                case 0:
                    r = i, g = s, b = n;
        ...
        function a(t) {
            if (t) {
                var e = /^#([a-fA-F0-9]{3})$/, i = /^#([a-fA-F0-9]{6})$/, a = /^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, s = /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, o = /(\w+)/, n = [0, 0, 0], r = 1, l = t.match(e);
                if (l) {
                    l = l[1];
        ...
        function s(t) {
            if (t) {
                ...
                if (i) {
                    var a = parseFloat(i[4]), s = v(parseInt(i[1]), 0, 360), o = v(parseFloat(i[2]), 0, 100), n = v(parseFloat(i[3]), 0, 100), r = v(isNaN(a) ? 1 : a, 0, 1);
                    return [s, o, n, r]
                }
            }
        }
        ...
        var a = t("color-convert"), s = t("color-string"), o = function (t) {
        ...
        o.prototype = {
            rgb: function (t) {
                ...
                e = 1 - (null == e ? .5 : e);
                for (var i = 2 * e - 1, a = this.alpha() - t.alpha(), s = ((i * a == -1 ? i : (i + a) / (1 + i * a)) + 1) / 2, o = 1 - s, n = this.rgbArray(), r = t.rgbArray(), l = 0; l < n.length; l++)n[l] = n[l] * s + r[l] * o;
            ...
            if (this.values.alpha = Math.max(0, Math.min(1, void 0 !== o ? o : this.values.alpha)), "alpha" != t) {
                for (var n = 0; n < t.length; n++) {
                    var l = Math.max(0, Math.min(s[t][n], this.values[t][n]));
                    this.values[t][n] = Math.round(l)
                }
                for (var h in i) {
                    h != t && (this.values[h] = a[t][h](this.values[t]));
                    for (var n = 0; n < h.length; n++) {
                        var l = Math.max(0, Math.min(s[h][n], this.values[h][n]));
    ...
    }, {"color-convert": 2, "color-string": 3}], 6: [function (t, e, i) {
//! moment.js
//! version : 2.10.6
...
//! momentjs.com
        !function (t, a) {
            "object" == typeof i && "undefined" != typeof e ? e.exports = a() : "function" == typeof define && define.amd ? define(a) : t.moment = a()
        }(this, function () {
            "use strict";
            function i() {
            ...
            function x(t, e, i) {
                var a, s = Math.min(t.length, e.length), o = Math.abs(t.length - e.length), n = 0;
                for (a = 0; s > a; a++)(i && t[a] !== e[a] || !i && v(t[a]) !== v(e[a])) && n++;
                return n + o
            }
            ...
            function _(t) {
                for (var e, i, a, s, o = 0; o < t.length;) {
                    for (s = k(t[o]).split("-"), e = s.length, i = k(t[o + 1]), i = i ? i.split("-") : null; e > 0;) {
                        if (a = D(s.slice(0, e).join("-")))return a;
            ...
            function S(t, e) {
                var i;
                return t && (i = "undefined" == typeof e ? C(t) : w(t, e), i && (Li = i)), Li._abbr
            }

            function w(t, e) {
                return null !== e ? (e.abbr = t, Bi[t] = Bi[t] || new y, Bi[t].set(e), S(t), Bi[t]) : (delete Bi[t], null)
            }
            ...
            function O(t, e) {
                var i;
                if ("object" == typeof t)for (i in t)this.set(i, t[i]); else if (t = A(t), "function" == typeof this[t])return this[t](e);
                return this
            }

            function V(t, e, i) {
                var a = "" + Math.abs(t), s = e - a.length, o = t >= 0;
            ...
            function R(t) {
                var e, i, a = t.match(Ni);
                for (e = 0, i = a.length; i > e; e++)Ui[a[e]] ? a[e] = Ui[a[e]] : a[e] = L(a[e]);
                return function (s) {
                    var o = "";
                    for (e = 0; i > e; e++)o += a[e]instanceof Function ? a[e].call(s, t) : a[e];
                    return o
                }
            }
            ...
            function B(t, e) {
                ...
                var a = 5;
                for (Hi.lastIndex = 0; a >= 0 && Hi.test(t);)t = t.replace(Hi, i), Hi.lastIndex = 0, a -= 1;
                return t
            }
            ...
            function U(t, e) {
                var i, a = e;
                for ("string" == typeof t && (t = [t]), "number" == typeof e && (a = function (t, i) {
                    i[e] = v(t)
                }), i = 0; i < t.length; i++)na[t[i]] = a
            }
            ...
            function J(t, e, i) {
                ...
                for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), a = 0; 12 > a; a++) {
                    if (s = h([2e3, a]), i && !this._longMonthsParse[a] && (this._longMonthsParse[a] = new RegExp("^" + this.months(s, "").replace(".", "") + "$", "i"), this._shortMonthsParse[a] = new RegExp("^" + this.monthsShort(s, "").replace(".", "") + "$", "i")), i || this._monthsParse[a] || (o = "^" + this.months(s, "") + "|^" + this.monthsShort(s, ""), this._monthsParse[a] = new RegExp(o.replace(".", ""), "i")), i && "MMMM" === e && this._longMonthsParse[a].test(t))return a;
            ...
            function tt(t) {
                var e, i = t._a;
                return i && -2 === u(t).overflow && (e = i[la] < 0 || i[la] > 11 ? la : i[ha] < 1 || i[ha] > G(i[ra], i[la]) ? ha : i[ca] < 0 || i[ca] > 24 || 24 === i[ca] && (0 !== i[ua] || 0 !== i[da] || 0 !== i[fa]) ? ca : i[ua] < 0 || i[ua] > 59 ? ua : i[da] < 0 || i[da] > 59 ? da : i[fa] < 0 || i[fa] > 999 ? fa : -1, u(t)._overflowDayOfYear && (ra > e || e > ha) && (e = ha), u(t).overflow = e), t
            }
            ...
            function st(t) {
                var e, i, a = t._i, s = ba.exec(a);
                if (s) {
                    for (u(t).iso = !0, e = 0, i = va.length; i > e; e++)if (va[e][1].exec(a)) {
                        t._f = va[e][0];
                        break
                    }
                    for (e = 0, i = xa.length; i > e; e++)if (xa[e][1].exec(a)) {
                        t._f += (s[6] || " ") + xa[e][0];
                        break
                    }
                    a.match(ia) && (t._f += "Z"), Dt(t)
                } else t._isValid = !1
            }
            ...
            function bt(t, e, i, a, s) {
                var o, n = 6 + s - a, r = rt(t, 0, 1 + n), l = r.getUTCDay();
                return s > l && (l += 7), i = null != i ? 1 * i : s, o = 1 + n + 7 * (e - 1) - l + i, {
                    year: o > 0 ? t : t - 1,
            ...
            function kt(t) {
                var e, i, a, s, o = [];
                if (!t._d) {
                    for (a = yt(t), t._w && null == t._a[ha] && null == t._a[la] && _t(t), t._dayOfYear && (s = xt(t._a[ra], a[ra]), t._dayOfYear > lt(s) && (u(t)._overflowDayOfYear = !0), i = rt(s, 0, t._dayOfYear), t._a[la] = i.getUTCMonth(), t._a[ha] = i.getUTCDate()), e = 0; 3 > e && null == t._a[e]; ++e)t._a[e] = o[e] = a[e];
                    for (; 7 > e; e++)t._a[e] = o[e] = null == t._a[e] ? 2 === e ? 1 : 0 : t._a[e];
                    24 === t._a[ca] && 0 === t._a[ua] && 0 === t._a[da] && 0 === t._a[fa] && (t._nextDay = !0, t._a[ca] = 0), t._d = (t._useUTC ? rt : nt).apply(null, o), null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm), t._nextDay && (t._a[ca] = 24)
                }
            }

            function _t(t) {
                var e, i, a, s, o, n, r;
                e = t._w, null != e.GG || null != e.W || null != e.E ? (o = 1, n = 4, i = xt(e.GG, t._a[ra], ut(Ft(), 1, 4).year), a = xt(e.W, 1), s = xt(e.E, 1)) : (o = t._locale._week.dow, n = t._locale._week.doy, i = xt(e.gg, t._a[ra], ut(Ft(), o, n).year), a = xt(e.w, 1), null != e.d ? (s = e.d, o > s && ++a) : s = null != e.e ? e.e + o : o), r = bt(i, a, s, n, o), t._a[ra] = r.year, t._dayOfYear = r.dayOfYear
            }

            function Dt(t) {
                if (t._f === i.ISO_8601)return void st(t);
                t._a = [], u(t).empty = !0;
                var e, a, s, o, n, r = "" + t._i, l = r.length, h = 0;
                for (s = B(t._f, t._locale).match(Ni) || [], e = 0; e < s.length; e++)o = s[e], a = (r.match(H(o, t)) || [])[0], a && (n = r.substr(0, r.indexOf(a)), n.length > 0 && u(t).unusedInput.push(n), r = r.slice(r.indexOf(a) + a.length), h += a.length), Ui[o] ? (a ? u(t).empty = !1 : u(t).unusedTokens.push(o), q(o, a, t)) : t._strict && !a && u(t).unusedTokens.push(o);
                u(t).charsLeftOver = l - h, r.length > 0 && u(t).unusedInput.push(r), u(t).bigHour === !0 && t._a[ca] <= 12 && t._a[ca] > 0 && (u(t).bigHour = void 0), t._a[ca] = St(t._locale, t._a[ca], t._meridiem), kt(t), tt(t)
            }
            ...
            function wt(t) {
                ...
                for (s = 0; s < t._f.length; s++)o = 0, e = g({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[s], Dt(e), d(e) && (o += u(e).charsLeftOver, o += 10 * u(e).unusedTokens.length, u(e).score = o, (null == a || a > o) && (a = o, i = e));
                l(t, i || e)
            }
            ...
            function At(t) {
                var e = t._i, i = t._f;
                return t._locale = t._locale || C(t._l), null === e || void 0 === i && "" === e ? f({nullInput: !0}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), p(e) ? new m(tt(e)) : (s(i) ? wt(t) : i ? Dt(t) : o(e) ? t._d = e : It(t), t))
            }
            ...
            function It(t) {
                ...
                }), kt(t)) : "object" == typeof e ? Ct(t) : "number" == typeof e ? t._d = new Date(e) : i.createFromInputFallback(t)
            }

            function Tt(t, e, i, a, s) {
                var o = {};
                return "boolean" == typeof i && (a = i, i = void 0), o._isAMomentObject = !0, o._useUTC = o._isUTC = s, o._l = i, o._i = t, o._f = e, o._strict = a, Mt(o)
            }
            ...
            function Pt(t, e) {
                ...
                for (i = e[0], a = 1; a < e.length; ++a)(!e[a].isValid() || e[a][t](i)) && (i = e[a]);
                return i
            }
            ...
            function Wt(t) {
                var e = I(t), i = e.year || 0, a = e.quarter || 0, s = e.month || 0, o = e.week || 0, n = e.day || 0, r = e.hour || 0, l = e.minute || 0, h = e.second || 0, c = e.millisecond || 0;
                this._milliseconds = +c + 1e3 * h + 6e4 * l + 36e5 * r, this._days = +n + 7 * o, this._months = +s + 3 * a + 12 * i, this._data = {}, this._locale = C(), this._bubble()
            }
            ...
            function zt(t) {
                var e = (t || "").match(ia) || [], i = e[e.length - 1] || [], a = (i + "").match(wa) || ["-", 0, 0], s = +(60 * a[1]) + v(a[2]);
                return "+" === a[0] ? s : -s
            }
            ...
            function $t(t, e) {
                var i, a, s, o = t, n = null;
                return Lt(t) ? o = {
                    ms: t._milliseconds,
                    d: t._days,
                    M: t._months
                } : "number" == typeof t ? (o = {}, e ? o[e] = t : o.milliseconds = t) : (n = Ca.exec(t)) ? (i = "-" === n[1] ? -1 : 1, o = {
                    y: 0,
                    d: v(n[ha]) * i,
                    h: v(n[ca]) * i,
                    m: v(n[ua]) * i,
                    ...
                    s: Kt(n[7], i),
                    w: Kt(n[8], i)
                }) : null == o ? o = {} : "object" == typeof o && ("from"in o || "to"in o) && (s = ee(Ft(o.from), Ft(o.to)), o = {}, o.ms = s.milliseconds, o.M = s.months), a = new Wt(o), Lt(t) && r(t, "_locale") && (a._locale = t._locale), a
            }
            ...
            function se(t, e) {
                var i = t || Ft(), a = Bt(i, this).startOf("day"), s = this.diff(a, "days", !0), o = -6 > s ? "sameElse" : -1 > s ? "lastWeek" : 0 > s ? "lastDay" : 1 > s ? "sameDay" : 2 > s ? "nextDay" : 7 > s ? "nextWeek" : "sameElse";
            ...
            function ce(t, e, i) {
                var a, s, o = Bt(t, this), n = 6e4 * (o.utcOffset() - this.utcOffset());
                return e = A(e), "year" === e || "month" === e || "quarter" === e ? (s = ue(this, o), "quarter" === e ? s /= 3 : "year" === e && (s /= 12)) : (a = this - o, s = "second" === e ? a / 1e3 : "minute" === e ? a / 6e4 : "hour" === e ? a / 36e5 : "day" === e ? (a - n) / 864e5 : "week" === e ? (a - n) / 6048e5 : a), i ? s : b(s)
            }

            function ue(t, e) {
                var i, a, s = 12 * (e.year() - t.year()) + (e.month() - t.month()), o = t.clone().add(s, "months");
            ...
            function Pe(t, e, i) {
                return ut(Ft([t, 11, 31 + e - i]), e, i).week
            }
            ...
            function He(t) {
                var e, i, a;
                for (this._weekdaysParse = this._weekdaysParse || [], e = 0; 7 > e; e++)if (this._weekdaysParse[e] || (i = Ft([2e3, 1]).day(e), a = "^" + this.weekdays(i, "") + "|^" + this.weekdaysShort(i, "") + "|^" + this.weekdaysMin(i, ""), this._weekdaysParse[e] = new RegExp(a.replace(".", ""), "i")), this._weekdaysParse[e].test(t))return e
            }
            ...
            function ci(t, e, i, a, s) {
                if ("number" == typeof t && (e = t, t = void 0), t = t || "", null != e)return hi(t, e, i, s);
                var o, n = [];
                for (o = 0; a > o; o++)n[o] = hi(t, o, i, s);
                return n
            }
            ...
            function ki() {
                var t, e, i, a, s, o = this._milliseconds, n = this._days, r = this._months, l = this._data;
                return o >= 0 && n >= 0 && r >= 0 || 0 >= o && 0 >= n && 0 >= r || (o += 864e5 * yi(Di(r) + n), n = 0, r = 0), l.milliseconds = o % 1e3, t = b(o / 1e3), l.seconds = t % 60, e = b(t / 60), l.minutes = e % 60, i = b(e / 60), l.hours = i % 24, n += b(i / 24), s = b(_i(n)), r += s, n -= yi(Di(s)), a = b(r / 12), r %= 12, l.days = n, l.months = r, l.years = a, this
            }
            ...
            function Fi(t, e, i) {
                var a = $t(t).abs(), s = ds(a.as("s")), o = ds(a.as("m")), n = ds(a.as("h")), r = ds(a.as("d")), l = ds(a.as("M")), h = ds(a.as("y")), c = s < fs.s && ["s", s] || 1 === o && ["m"] || o < fs.m && ["mm", o] || 1 === n && ["h"] || n < fs.h && ["hh", n] || 1 === r && ["d"] || r < fs.d && ["dd", r] || 1 === l && ["M"] || l < fs.M && ["MM", l] || 1 === h && ["y"] || ["yy", h];
            ...
            function Vi() {
                var t, e, i, a = gs(this._milliseconds) / 1e3, s = gs(this._days), o = gs(this._months);
                t = b(a / 60), e = b(t / 60), a %= 60, t %= 60, i = b(o / 12), o %= 12;
                var n = i, r = o, l = s, h = e, c = t, u = a, d = this.asSeconds();
                return d ? (0 > d ? "-" : "") + "P" + (n ? n + "Y" : "") + (r ? r + "M" : "") + (l ? l + "D" : "") + (h || c || u ? "T" : "") + (h ? h + "H" : "") + (c ? c + "M" : "") + (u ? u + "S" : "") : "P0D"
            }

            var Wi, Li, Ri = i.momentProperties = [], zi = !1, Bi = {}, Yi = {}, Ni = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Hi = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Ei = {}, Ui = {}, ji = /\d/, qi = /\d\d/, Gi = /\d{3}/, Zi = /\d{4}/, Qi = /[+-]?\d{6}/, Ji = /\d\d?/, Xi = /\d{1,3}/, $i = /\d{1,4}/, Ki = /[+-]?\d{1,6}/, ta = /\d+/, ea = /[+-]?\d+/, ia = /Z|[+-]\d\d:?\d\d/gi, aa = /[+-]?\d+(\.\d{1,3})?/, sa = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, oa = {}, na = {}, ra = 0, la = 1, ha = 2, ca = 3, ua = 4, da = 5, fa = 6;
            ...
            }), M("month", "M"), N("M", Ji), N("MM", Ji, qi), N("MMM", sa), N("MMMM", sa), U(["M", "MM"], function (t, e) {
                e[la] = v(t) - 1
            }), U(["MMM", "MMMM"], function (t, e, i, a) {
                var s = i._locale.monthsParse(t, a, i._strict);
                null != s ? e[la] = s : u(i).invalidMonth = t
            });
            var ga = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ma = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), pa = {};
            i.suppressDeprecationWarnings = !1;
            var ba = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/, va = [["YYYYYY-MM-DD", /[+-]\d{6}-\d{2}-\d{2}/], ["YYYY-MM-DD", /\d{4}-\d{2}-\d{2}/], ["GGGG-[W]WW-E", /\d{4}-W\d{2}-\d/], ["GGGG-[W]WW", /\d{4}-W\d{2}/], ["YYYY-DDD", /\d{4}-\d{3}/]], xa = [["HH:mm:ss.SSSS", /(T| )\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/], ["HH:mm", /(T| )\d\d:\d\d/], ["HH", /(T| )\d\d/]], ya = /^\/?Date\((\-?\d+)/i;
            ...
            }), W(0, ["YYYY", 4], 0, "year"), W(0, ["YYYYY", 5], 0, "year"), W(0, ["YYYYYY", 6, !0], 0, "year"), M("year", "y"), N("Y", ea), N("YY", Ji, qi), N("YYYY", $i, Zi), N("YYYYY", Ki, Qi), N("YYYYYY", Ki, Qi), U(["YYYYY", "YYYYYY"], ra), U("YYYY", function (t, e) {
            ...
            var ka = T("FullYear", !1);
            W("w", ["ww", 2], "wo", "week"), W("W", ["WW", 2], "Wo", "isoWeek"), M("week", "w"), M("isoWeek", "W"), N("w", Ji), N("ww", Ji, qi), N("W", Ji), N("WW", Ji, qi), j(["w", "ww", "W", "WW"], function (t, e, i, a) {
                e[a.substr(0, 1)] = v(t)
            });
            var _a = {dow: 0, doy: 6};
            W("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), M("dayOfYear", "DDD"), N("DDD", Xi), N("DDDD", Gi), U(["DDD", "DDDD"], function (t, e, i) {
                i._dayOfYear = v(t)
            }), i.ISO_8601 = function () {
            };
            var Da = it("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548", function () {
                var t = Ft.apply(null, arguments);
                return this > t ? this : t
            }), Sa = it("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548", function () {
                var t = Ft.apply(null, arguments);
                return t > this ? this : t
            });
            Rt("Z", ":"), Rt("ZZ", ""), N("Z", ia), N("ZZ", ia), U(["Z", "ZZ"], function (t, e, i) {
                i._useUTC = !0, i._tzm = zt(t)
            });
            var wa = /([\+\-]|\d\d)/gi;
            i.updateOffset = function () {
            };
            var Ca = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/, Ma = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/;
            $t.fn = Wt.prototype;
            var Aa = ie(1, "add"), Ia = ie(-1, "subtract");
            ...
            }), Fe("gggg", "weekYear"), Fe("ggggg", "weekYear"), Fe("GGGG", "isoWeekYear"), Fe("GGGGG", "isoWeekYear"), M("weekYear", "gg"), M("isoWeekYear", "GG"), N("G", ea), N("g", ea), N("GG", Ji, qi), N("gg", Ji, qi), N("GGGG", $i, Zi), N("gggg", $i, Zi), N("GGGGG", Ki, Qi), N("ggggg", Ki, Qi), j(["gggg", "ggggg", "GGGG", "GGGGG"], function (t, e, i, a) {
                e[a.substr(0, 2)] = v(t)
            }), j(["gg", "GG"], function (t, e, a, s) {
                e[s] = i.parseTwoDigitYear(t)
            }), W("Q", 0, 0, "quarter"), M("quarter", "Q"), N("Q", ji), U("Q", function (t, e) {
                e[la] = 3 * (v(t) - 1)
            }), W("D", ["DD", 2], "Do", "date"), M("date", "D"), N("D", Ji), N("DD", Ji, qi), N("Do", function (t, e) {
                return t ? e._ordinalParse : e._ordinalParseLenient
            }), U(["D", "DD"], ha), U("Do", function (t, e) {
                e[ha] = v(t.match(Ji)[0], 10)
            });
            var Fa = T("Date", !0);
            ...
            }), W("e", 0, 0, "weekday"), W("E", 0, 0, "isoWeekday"), M("day", "d"), M("weekday", "e"), M("isoWeekday", "E"), N("d", Ji), N("e", Ji), N("E", Ji), N("dd", sa), N("ddd", sa), N("dddd", sa), j(["dd", "ddd", "dddd"], function (t, e, i) {
                var a = i._locale.weekdaysParse(t);
                null != a ? e.d = a : u(i).invalidWeekday = t
            }), j(["d", "e", "E"], function (t, e, i, a) {
                e[a] = v(t)
            });
            var Pa = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), Oa = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), Va = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
            W("H", ["HH", 2], 0, "hour"), W("h", ["hh", 2], 0, function () {
                return this.hours() % 12 || 12
            }), qe("a", !0), qe("A", !1), M("hour", "h"), N("a", Ge), N("A", Ge), N("H", Ji), N("h", Ji), N("HH", Ji, qi), N("hh", Ji, qi), U(["H", "HH"], ca), U(["a", "A"], function (t, e, i) {
                i._isPm = i._locale.isPM(t), i._meridiem = t
            }), U(["h", "hh"], function (t, e, i) {
                e[ca] = v(t), u(i).bigHour = !0
            });
            var Wa = /[ap]\.?m?\.?/i, La = T("Hours", !0);
            W("m", ["mm", 2], 0, "minute"), M("minute", "m"), N("m", Ji), N("mm", Ji, qi), U(["m", "mm"], ua);
            var Ra = T("Minutes", !1);
            W("s", ["ss", 2], 0, "second"), M("second", "s"), N("s", Ji), N("ss", Ji, qi), U(["s", "ss"], da);
            var za = T("Seconds", !1);
            W("S", 0, 0, function () {
            ...
            }, ja = "Invalid date", qa = "%d", Ga = /\d{1,2}/, Za = {
                future: "in %s",
                past: "%s ago",
                s: "a few seconds",
                m: "a minute",
     ...
     */
                ...
                initialize: function (e, i) {
                    ...
                    if (a.options.stacked) {
                        ...
                        if (0 > o)for (var n = 0; t > n; n++) {
                            ...
                            e.isDatasetVisible(h) && h.yAxisID === a.id && h.bar && (s += h.data[i] > 0 ? h.data[i] : 0)
                        }
                    ...
                    if (a.options.stacked) {
                        for (var o = 0, n = 0, r = 0; i > r; r++) {
                            ...
                            e.isDatasetVisible(l) && l.bar && l.yAxisID === a.id && (l.data[t] < 0 ? n += l.data[t] || 0 : o += l.data[t] || 0)
                        }
        ...
        e.exports = function (t) {
            ...
            t.defaults.bubble = {
                ...
                addElements: function () {
                    ...
                    var i, a = this.getDataset().metaData, s = this.getScaleForId(this.getDataset().yAxisID);
        ...
        e.exports = function (t) {
            ...
            t.defaults.doughnut = {
                ...
                linkScales: function () {
                    ...
                    this.getDataset().metaData = this.getDataset().metaData || [];
                    var s = new t.elements.Arc({_chart: this.chart.chart, _datasetIndex: this.index, _index: i});
                    ...
                    var i = this.chart.chartArea.right - this.chart.chartArea.left - this.chart.options.elements.arc.borderWidth, a = this.chart.chartArea.bottom - this.chart.chartArea.top - this.chart.options.elements.arc.borderWidth, s = Math.min(i, a), o = {
                        x: 0,
                        y: 0
                    };
                    if (this.chart.options.circumference && this.chart.options.circumference < 2 * Math.PI) {
                        ...
                        var r = n + this.chart.options.circumference, l = {
                            x: Math.cos(n),
                            y: Math.sin(n)
                        }, h = {
                            x: Math.cos(r),
                            y: Math.sin(r)
                        }, c = 0 >= n && r >= 0 || n <= 2 * Math.PI && 2 * Math.PI <= r, u = n <= .5 * Math.PI && .5 * Math.PI <= r || n <= 2.5 * Math.PI && 2.5 * Math.PI <= r, d = n <= -Math.PI && -Math.PI <= r || n <= Math.PI && Math.PI <= r, f = n <= .5 * -Math.PI && .5 * -Math.PI <= r || n <= 1.5 * Math.PI && 1.5 * Math.PI <= r, g = this.chart.options.cutoutPercentage / 100, m = {
                            x: d ? -1 : Math.min(l.x * (l.x < 0 ? 1 : g), h.x * (h.x < 0 ? 1 : g)),
                            y: f ? -1 : Math.min(l.y * (l.y < 0 ? 1 : g), h.y * (h.y < 0 ? 1 : g))
                        }, p = {
                            x: c ? 1 : Math.max(l.x * (l.x > 0 ? 1 : g), h.x * (h.x > 0 ? 1 : g)),
                            y: u ? 1 : Math.max(l.y * (l.y > 0 ? 1 : g), h.y * (h.y > 0 ? 1 : g))
                        }, b = {width: .5 * (p.x - m.x), height: .5 * (p.y - m.y)};
                        s = Math.min(i / b.width, a / b.height), o = {x: (p.x + m.x) * -.5, y: (p.y + m.y) * -.5}
                    }
                    ...
                    var s = (this.chart.chartArea.left + this.chart.chartArea.right) / 2, o = (this.chart.chartArea.top + this.chart.chartArea.bottom) / 2, n = this.chart.options.rotation || Math.PI * -.5, r = this.chart.options.rotation || Math.PI * -.5, l = a && this.chart.options.animation.animateRotate ? 0 : this.calculateCircumference(this.getDataset().data[i]) * ((this.chart.options.circumference || 2 * Math.PI) / (2 * Math.PI)), h = a && this.chart.options.animation.animateScale ? 0 : this.innerRadius, c = a && this.chart.options.animation.animateScale ? 0 : this.outerRadius;
                    e.extend(t, {
                        _chart: this.chart.chart,
                        _datasetIndex: this.index,
                        _index: i,
        ...
        e.exports = function (t) {
            ...
            t.defaults.line = {
                ...
                addElements: function () {
                    ...
                    var i, a = this.getDataset().metaDataset, s = this.getDataset().metaData, o = this.getScaleForId(this.getDataset().yAxisID);
                    this.getScaleForId(this.getDataset().xAxisID);
        ...
        e.exports = function (t) {
            ...
            t.defaults.radar = {
                ...
                linkScales: function () {
                    ...
                    var i, a = this.getDataset().metaDataset, s = this.getDataset().metaData, o = this.chart.scale;
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.animation = {
                ...
                addAnimation: function (t, e, i, a) {
                    a || (t.animating = !0);
                    for (var s = 0; s < this.animations.length; ++s)if (this.animations[s].chartInstance === t)return void(this.animations[s].animationObject = e);
                ...
                startDigest: function () {
                    ...
                    var a = Date.now(), s = (a - t) / this.frameDuration;
        ...
        e.exports = function (t) {
            ...
            t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (i) {
                ...
                initialize: function () {
                    ...
                    var i = this.chart.canvas, a = e.getMaximumWidth(this.chart.canvas), s = this.options.maintainAspectRatio && isNaN(this.chart.aspectRatio) === !1 && isFinite(this.chart.aspectRatio) && 0 !== this.chart.aspectRatio ? a / this.chart.aspectRatio : e.getMaximumHeight(this.chart.canvas), o = this.chart.width !== a || this.chart.height !== s;
                    ...
                    if (this.scales = {}, this.options.scales && (this.options.scales.xAxes && this.options.scales.xAxes.length && e.each(this.options.scales.xAxes, function (i, a) {
                            var s = e.getValueOrDefault(i.type, "category"), o = t.scaleService.getScaleConstructor(s);
                            if (o) {
                            ...
                            var s = e.getValueOrDefault(i.type, "linear"), o = t.scaleService.getScaleConstructor(s);
                            if (o) {
                                var n = new o({ctx: this.chart.ctx, options: i, chart: this, id: i.id});
                                this.scales[n.id] = n
                            }
                    ...
                    if (e.each(this.data.datasets, function (e, s) {
                        ...
                        }, this), i.length > 1)for (var s = 1; s < i.length; s++)if (i[s] !== i[s - 1]) {
                        this.isCombo = !0;
                        break
                    }
                    return a
                    ...
                    if (this.options.animation && ("undefined" != typeof i && 0 !== i || "undefined" == typeof i && 0 !== this.options.animation.duration)) {
                        ...
                        s.numSteps = (i || this.options.animation.duration) / 16.66, s.easing = this.options.animation.easing, s.render = function (t, i) {
                            var a = e.easingEffects[i.easing], s = i.currentStep / i.numSteps, o = a(s);
                    ...
                    var i = e.getRelativePosition(t, this.chart), a = [], s = function () {
                        if (this.data.datasets)for (var t = 0; t < this.data.datasets.length; t++)if (e.isDatasetVisible(this.data.datasets[t]))for (var a = 0; a < this.data.datasets[t].metaData.length; a++)if (this.data.datasets[t].metaData[a].inRange(i.x, i.y))return this.data.datasets[t].metaData[a]
                    }.call(this);
        ...
        e.exports = function (t) {
            ...
            function i(t, i, a) {
                var s, o = document.defaultView.getComputedStyle(t)[i], n = document.defaultView.getComputedStyle(t.parentNode)[i], r = null !== o && "none" !== o, l = null !== n && "none" !== n;
                return (r || l) && (s = Math.min(r ? e(o, t, a) : Number.POSITIVE_INFINITY, l ? e(n, t.parentNode, a) : Number.POSITIVE_INFINITY)), s
            }

            var s = t.helpers = {};
            s.each = function (t, e, i, a) {
                var o, n;
                if (s.isArray(t))if (n = t.length, a)for (o = n - 1; o >= 0; o--)e.call(i, t[o], o); else for (o = 0; n > o; o++)e.call(i, t[o], o); else if ("object" == typeof t) {
                    var r = Object.keys(t);
                ...
                return s.each(i, function (e, o) {
                    i.hasOwnProperty(o) && ("xAxes" === o || "yAxes" === o ? a.hasOwnProperty(o) ? s.each(e, function (e, i) {
                        var n = s.getValueOrDefault(e.type, "xAxes" === o ? "category" : "linear"), r = t.scaleService.getScaleDefaults(n);
                ...
                var a = -1;
                if (Array.prototype.findIndex)a = t.findIndex(e, i); else for (var s = 0; s < t.length; ++s)if (i = void 0 !== i ? i : t, e.call(i, t[s], s, t)) {
                    a = s;
                    break
                }
                return a
                ...
                var s = t.skip ? e : t, o = e, n = i.skip ? e : i, r = Math.sqrt(Math.pow(o.x - s.x, 2) + Math.pow(o.y - s.y, 2)), l = Math.sqrt(Math.pow(n.x - o.x, 2) + Math.pow(n.y - o.y, 2)), h = r / (r + l), c = l / (r + l);
                h = isNaN(h) ? 0 : h, c = isNaN(c) ? 0 : c;
                var u = a * h, d = a * c;
                return {
                    previous: {x: o.x - u * (n.x - s.x), y: o.y - u * (n.y - s.y)},
                    next: {x: o.x + d * (n.x - s.x), y: o.y + d * (n.y - s.y)}
                }
                ...
                var i, a = Math.floor(s.log10(t)), o = t / Math.pow(10, a);
            ...
            s.requestAnimFrame = function () {
                ...
                var i, a, o = t.originalEvent || t, n = t.currentTarget || t.srcElement, r = n.getBoundingClientRect();
                o.touches && o.touches.length > 0 ? (i = o.touches[0].clientX, a = o.touches[0].clientY) : (i = o.clientX, a = o.clientY);
                var l = parseFloat(s.getStyle(n, "padding-left")), h = parseFloat(s.getStyle(n, "padding-top")), c = parseFloat(s.getStyle(n, "padding-right")), u = parseFloat(s.getStyle(n, "padding-bottom")), d = r.right - r.left - l - c, f = r.bottom - r.top - h - u;
                return i = Math.round((i - r.left - l) / d * n.width / e.currentDevicePixelRatio), a = Math.round((a - r.top - h) / f * n.height / e.currentDevicePixelRatio), {
                    x: i,
                    y: a
                }
                ...
                var e = t.parentNode, i = parseInt(s.getStyle(e, "padding-left")) + parseInt(s.getStyle(e, "padding-right")), a = e.clientWidth - i, o = s.getConstraintWidth(t);
                return void 0 !== o && (a = Math.min(a, o)), a
            }, s.getMaximumHeight = function (t) {
                var e = t.parentNode, i = parseInt(s.getStyle(e, "padding-top")) + parseInt(s.getStyle(e, "padding-bottom")), a = e.clientHeight - i, o = s.getConstraintHeight(t);
                return void 0 !== o && (a = Math.min(a, o)), a
    ...
    }, {"chartjs-color": 5}], 26: [function (t, e, i) {
        "use strict";
        e.exports = function () {
            var t = function (e, i) {
            ...
            t.layoutService = {
                defaults: {}, addBox: function (t, e) {
                    ...
                    function s(t) {
                        ...
                        i ? (e = t.update(t.options.fullWidth ? m : k, y), _ -= e.height) : (e = t.update(x, v), k -= e.width), D.push({
                            horizontal: i,
                            minSize: e,
                            box: t
                        })
                    ...
                    function n(t) {
                        var i = e.findNextWhere(D, function (e) {
                            return e.box === t
                        }), a = {left: 0, right: 0, top: C, bottom: M};
                        i && t.update(i.minSize.width, _, a)
                    }

                    function r(t) {
                        t.isHorizontal() ? (t.left = t.options.fullWidth ? l : S, t.right = t.options.fullWidth ? i - l : S + k, t.top = F, t.bottom = F + t.height, F = t.bottom) : (t.left = T, t.right = T + t.width, t.top = C, t.bottom = C + _, T = t.right)
                    }

                    if (t) {
                        var l = 0, h = 0, c = e.where(t.boxes, function (t) {
                        ...
                        var m = i - 2 * l, p = a - 2 * h, b = m / 2, v = p / 2, x = (i - b) / (c.length + u.length), y = (a - v) / (d.length + f.length), k = m, _ = p, D = [];
                        e.each(c.concat(u, d, f), s);
                        var S = l, w = l, C = h, M = h;
                        ...
                        var T = l, F = h;
                        e.each(c.concat(d), r), T += k, F += _, e.each(u, r), e.each(f, r), t.chartArea = {
                            left: S,
                            top: C,
                            right: S + k,
                            bottom: C + _
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.legend = {
                ...
                initialize: function (t) {
                    ...
                    var i = this.ctx, a = e.getValueOrDefault(this.options.labels.fontSize, t.defaults.global.defaultFontSize), s = e.getValueOrDefault(this.options.labels.fontStyle, t.defaults.global.defaultFontStyle), o = e.getValueOrDefault(this.options.labels.fontFamily, t.defaults.global.defaultFontFamily), n = e.fontString(a, s, o);
                    ...
                    if (this.options.display) {
                        var i = this.ctx, a = {
                            ...
                            line: 0
                        }, s = e.getValueOrDefault(this.options.labels.fontColor, t.defaults.global.defaultFontColor), o = e.getValueOrDefault(this.options.labels.fontSize, t.defaults.global.defaultFontSize), n = e.getValueOrDefault(this.options.labels.fontStyle, t.defaults.global.defaultFontStyle), r = e.getValueOrDefault(this.options.labels.fontFamily, t.defaults.global.defaultFontFamily), l = e.fontString(o, n, r);
                        this.isHorizontal() && (i.textAlign = "left", i.textBaseline = "top", i.lineWidth = .5, i.strokeStyle = s, i.fillStyle = s, i.font = l, e.each(this.legendItems, function (e, s) {
        ...
        e.exports = function (t) {
            ...
            t.defaults.scale = {
                ...
                beforeUpdate: function () {
                    ...
                    var i = e.getValueOrDefault(this.options.ticks.fontSize, t.defaults.global.defaultFontSize), a = e.getValueOrDefault(this.options.ticks.fontStyle, t.defaults.global.defaultFontStyle), s = e.getValueOrDefault(this.options.ticks.fontFamily, t.defaults.global.defaultFontFamily), o = e.fontString(i, a, s);
                    this.ctx.font = o;
                    var n, r = this.ctx.measureText(this.ticks[0]).width, l = this.ctx.measureText(this.ticks[this.ticks.length - 1]).width;
                    ...
                    if (this.isHorizontal() ? this.minSize.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth : this.minSize.width = this.options.gridLines.display && this.options.display ? 10 : 0, this.isHorizontal() ? this.minSize.height = this.options.gridLines.display && this.options.display ? 10 : 0 : this.minSize.height = this.maxHeight, this.options.scaleLabel.display && (this.isHorizontal() ? this.minSize.height += 1.5 * n : this.minSize.width += 1.5 * n), this.options.ticks.display && this.options.display) {
                        ...
                        if (this.isHorizontal()) {
                            ...
                            var u = this.ctx.measureText(this.ticks[0]).width, d = this.ctx.measureText(this.ticks[this.ticks.length - 1]).width, f = Math.cos(e.toRadians(this.labelRotation)), g = Math.sin(e.toRadians(this.labelRotation));
                            this.paddingLeft = 0 !== this.labelRotation ? f * u + 3 : u / 2 + 3, this.paddingRight = 0 !== this.labelRotation ? g * (i / 2) + 3 : d / 2 + 3
                        } else {
                            var m = this.maxWidth - this.minSize.width;
                            this.options.ticks.mirror || (h += this.options.ticks.padding), m > h ? this.minSize.width += h : this.minSize.width = this.maxWidth, this.paddingTop = i / 2, this.paddingBottom = i / 2
                        }
                    }
                    ...
                    if (this.options.display) {
                        ...
                        if (this.ctx.fillStyle = c, this.isHorizontal()) {
                            ...
                            }, this), this.options.scaleLabel.display && (this.ctx.textAlign = "center", this.ctx.textBaseline = "middle", this.ctx.fillStyle = m, this.ctx.font = x, o = this.left + (this.right - this.left) / 2, n = "bottom" === this.options.position ? this.bottom - p / 2 : this.top + p / 2, this.ctx.fillText(this.options.scaleLabel.labelString, o, n))
                        } else {
                            a = !0;
                            var S = "right" === this.options.position ? this.left : this.right - 5, w = "right" === this.options.position ? this.left + 5 : this.right;
                            if (e.each(this.ticks, function (t, s) {
                                    if (void 0 !== t && null !== t) {
                                        var o = this.getPixelForTick(s);
                                        if (this.options.gridLines.display && (s === ("undefined" != typeof this.zeroLineIndex ? this.zeroLineIndex : 0) ? (this.ctx.lineWidth = this.options.gridLines.zeroLineWidth, this.ctx.strokeStyle = this.options.gridLines.zeroLineColor, a = !0) : a && (this.ctx.lineWidth = this.options.gridLines.lineWidth, this.ctx.strokeStyle = this.options.gridLines.color, a = !1), o += e.aliasPixel(this.ctx.lineWidth), this.ctx.beginPath(), this.options.gridLines.drawTicks && (this.ctx.moveTo(S, o), this.ctx.lineTo(w, o)), this.options.gridLines.drawOnChartArea && (this.ctx.moveTo(i.left, o), this.ctx.lineTo(i.right, o)), this.ctx.stroke()), this.options.ticks.display) {
                                ...
                                this.ctx.save(), this.ctx.translate(o, n), this.ctx.rotate(C), this.ctx.textAlign = "center", this.ctx.fillStyle = m, this.ctx.font = x, this.ctx.textBaseline = "middle", this.ctx.fillText(this.options.scaleLabel.labelString, 0, 0), this.ctx.restore()
                            }
                        }
                        this.ctx.lineWidth = this.options.gridLines.lineWidth, this.ctx.strokeStyle = this.options.gridLines.color;
                        var M = this.left, A = this.right, I = this.top, T = this.bottom;
                        this.isHorizontal() ? (I = T = "top" === this.options.position ? this.bottom : this.top, I += e.aliasPixel(this.ctx.lineWidth), T += e.aliasPixel(this.ctx.lineWidth)) : (M = A = "left" === this.options.position ? this.right : this.left, M += e.aliasPixel(this.ctx.lineWidth), A += e.aliasPixel(this.ctx.lineWidth)), this.ctx.beginPath(), this.ctx.moveTo(M, I), this.ctx.lineTo(A, T), this.ctx.stroke()
                    }
                }
            })
        }
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.title = {
                ...
                beforeFit: e.noop,
                fit: function () {
                    var i = (this.ctx, e.getValueOrDefault(this.options.fontSize, t.defaults.global.defaultFontSize)), a = e.getValueOrDefault(this.options.fontStyle, t.defaults.global.defaultFontStyle), s = e.getValueOrDefault(this.options.fontFamily, t.defaults.global.defaultFontFamily);
                    e.fontString(i, a, s);
                ...
                draw: function () {
                    if (this.options.display) {
                        var i, a, s = this.ctx, o = e.getValueOrDefault(this.options.fontColor, t.defaults.global.defaultFontColor), n = e.getValueOrDefault(this.options.fontSize, t.defaults.global.defaultFontSize), r = e.getValueOrDefault(this.options.fontStyle, t.defaults.global.defaultFontStyle), l = e.getValueOrDefault(this.options.fontFamily, t.defaults.global.defaultFontFamily), h = e.fontString(n, r, l);
                        if (s.fillStyle = o, s.font = h, this.isHorizontal())s.textAlign = "center", s.textBaseline = "middle", i = this.left + (this.right - this.left) / 2, a = this.top + (this.bottom - this.top) / 2, s.fillText(this.options.text, i, a); else {
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.tooltips = {
                ...
                initialize: function () {
                    ...
                    var t = this._options.tooltips.callbacks.beforeTitle.apply(this, arguments), i = this._options.tooltips.callbacks.title.apply(this, arguments), a = this._options.tooltips.callbacks.afterTitle.apply(this, arguments), s = [];
                    ...
                    var t = this._options.tooltips.callbacks.beforeFooter.apply(this, arguments), i = this._options.tooltips.callbacks.footer.apply(this, arguments), a = this._options.tooltips.callbacks.afterFooter.apply(this, arguments), s = [];
                    return s = e(s, t), s = e(s, i), s = e(s, a)
                    ...
                    var e, i, a, s, o, n = this, r = (this._chartInstance.chartArea.left + this._chartInstance.chartArea.right) / 2, l = (this._chartInstance.chartArea.top + this._chartInstance.chartArea.bottom) / 2;
                    ...
                    d.fillStyle = f.alpha(a * f.alpha()).rgbString(), d.beginPath(), d.moveTo(o, l), d.lineTo(n, h), d.lineTo(r, c), d.closePath(), d.fill()
                    ...
                    if (0 !== e.opacity) {
                        var a = e.caretPadding, s = this.getTooltipSize(e), o = {
                            x: e.x,
                            y: e.y
            ...
            t.defaults.global.elements.arc = {
                ...
                inLabelRange: function (t) {
                    ...
                    if (a) {
                        ...
                        var r = s.angle >= o && s.angle <= n, l = s.distance >= a.innerRadius && s.distance <= a.outerRadius;
                        return r && l
                    }
                    return !1
                }, tooltipPosition: function () {
            ...
            t.defaults.global.elements.line = {
                ...
                lineToNextPoint: function (t, e, i, a, s) {
                    ...
                    o.save(), this._children.length > 0 && s.fill && (o.beginPath(), e.each(this._children, function (t, i) {
                        ...
                        var a = e.previousItem(this._children, i), s = e.nextItem(this._children, i);
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.point = {
                ...
                inRange: function (t, e) {
                    ...
                    var i = this._view, a = this._chart.ctx;
                    if (!i.skip) {
                        ...
                        if (!isNaN(i.radius) && i.radius > 0) {
                            ...
                            switch (i.pointStyle) {
                                ...
                                case"triangle":
                                    ...
                                    a.moveTo(i.x - r / 2, i.y + l / 3), a.lineTo(i.x + r / 2, i.y + l / 3), a.lineTo(i.x, i.y - 2 * l / 3), a.closePath(), a.fill();
                                    break;
                                case"rect":
        ...
        e.exports = function (t) {
            ...
            t.defaults.global.elements.rectangle = {
                ...
                draw: function () {
                    ...
                    var e = this._chart.ctx, i = this._view, a = i.width / 2, s = i.x - a, o = i.x + a, n = i.base - (i.base - i.y), r = i.borderWidth / 2;
                    ...
                    var l = [[s, i.base], [s, n], [o, n], [o, i.base]], h = ["bottom", "left", "top", "right"], c = h.indexOf(i.borderSkipped, 0);
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {position: "bottom"}, a = t.Scale.extend({
                buildTicks: function (t) {
                    ...
                    if (this.isHorizontal()) {
                        var o = this.width - (this.paddingLeft + this.paddingRight), n = o / s, r = n * (e - this.startIndex) + this.paddingLeft;
                        return this.options.gridLines.offsetGridLines && a && (r += n / 2), this.left + Math.round(r)
                    }
                    var l = this.height - (this.paddingTop + this.paddingBottom), h = l / s, c = h * (e - this.startIndex) + this.paddingTop;
                    return this.options.gridLines.offsetGridLines && a && (c += h / 2), this.top + Math.round(c)
                ...
                determineDataLimits: function () {
                    if (this.min = null, this.max = null, this.options.stacked) {
                        ...
                        e.each(this.chart.data.datasets, function (s) {
                            void 0 === t[s.type] && (t[s.type] = {positiveValues: [], negativeValues: []});
                            var o = t[s.type].positiveValues, n = t[s.type].negativeValues;
                            ...
                            var i = t.positiveValues.concat(t.negativeValues), a = e.min(i), s = e.max(i);
                    ...
                    if (this.options.ticks.beginAtZero) {
                        var s = e.sign(this.min), o = e.sign(this.max);
                    ...
                    var r = Math.floor(this.min / s) * s, l = Math.ceil(this.max / s) * s, h = (l - r) / s;
                    h = e.almostEquals(h, Math.round(h), s / 1e3) ? Math.round(h) : Math.ceil(h), this.ticks.push(void 0 !== this.options.ticks.min ? this.options.ticks.min : r);
                    for (var c = 1; h > c; ++c)this.ticks.push(r + c * s);
                    ...
                    return s = this.bottom - this.paddingBottom - l / n * (o - this.start), Math.round(s)
                }, getPixelForTick: function (t, e) {
                    ...
                    if (this.min = null, this.max = null, this.options.stacked) {
                        ...
                        e.each(this.chart.data.datasets, function (i) {
                            e.isDatasetVisible(i) && (this.isHorizontal() ? i.xAxisID === this.id : i.yAxisID === this.id) && (void 0 === t[i.type] && (t[i.type] = []), e.each(i.data, function (e, a) {
                                var s = t[i.type], o = +this.getRightValue(e);
        ...
        e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                getValueCount: function () {
                    ...
                    var i = e.min([this.height, this.width]), a = e.getValueOrDefault(this.options.ticks.fontSize, t.defaults.global.defaultFontSize);
                    ...
                    this.ticks = [];
                    var i = e.getValueOrDefault(this.options.ticks.fontSize, t.defaults.global.defaultFontSize), a = Math.min(this.options.ticks.maxTicksLimit ? this.options.ticks.maxTicksLimit : 11, Math.ceil(this.drawingArea / (1.5 * i)));
                    a = Math.max(2, a);
                    var s = e.niceNum(this.max - this.min, !1), o = e.niceNum(s / (a - 1), !0), n = Math.floor(this.min / o) * o, r = Math.ceil(this.max / o) * o, l = Math.ceil((r - n) / o);
                    ...
                    var i, a, s, o, n, r, l, h, c, u, d, f, g = e.getValueOrDefault(this.options.pointLabels.fontSize, t.defaults.global.defaultFontSize), m = e.getValueOrDefault(this.options.pointLabels.fontStyle, t.defaults.global.defaultFontStyle), p = e.getValueOrDefault(this.options.pointLabels.fontFamily, t.defaults.global.defaultFontFamily), b = e.fontString(g, m, p), v = e.min([this.height / 2 - g - 5, this.width / 2]), x = this.width, y = 0;
                    for (this.ctx.font = b, a = 0; a < this.getValueCount(); a++)i = this.getPointPosition(a, v), s = this.ctx.measureText(this.pointLabels[a] ? this.pointLabels[a] : "").width + 5, 0 === a || a === this.getValueCount() / 2 ? (o = s / 2, i.x + o > x && (x = i.x + o, n = a), i.x - o < y && (y = i.x - o, l = a)) : a < this.getValueCount() / 2 ? i.x + s > x && (x = i.x + s, n = a) : a > this.getValueCount() / 2 && i.x - s < y && (y = i.x - s, l = a);
                    ...
                    if (this.options.display) {
                        ...
                        if (e.each(this.ticks, function (a, s) {
                                if (s > 0 || this.options.reverse) {
                                    var o = this.getDistanceFromCenterForValue(this.ticks[s]), n = this.yCenter - o;
                                    ...
                                    if (this.options.ticks.display) {
                                        ...
                                        i.textAlign = "center", i.textBaseline = "middle", i.fillStyle = h, i.fillText(a, this.xCenter, n)
                                    }
                                }
                            ...
                            for (var a = this.getValueCount() - 1; a >= 0; a--) {
                                ...
                                var o = this.getPointPosition(a, this.getDistanceFromCenterForValue(this.options.reverse ? this.min : this.max) + 5), n = e.getValueOrDefault(this.options.pointLabels.fontColor, t.defaults.global.defaultFontColor), r = e.getValueOrDefault(this.options.pointLabels.fontSize, t.defaults.global.defaultFontSize), l = e.getValueOrDefault(this.options.pointLabels.fontStyle, t.defaults.global.defaultFontStyle), h = e.getValueOrDefault(this.options.pointLabels.fontFamily, t.defaults.global.defaultFontFamily), c = e.fontString(r, l, h);
                                i.font = c, i.fillStyle = n;
                                var u = this.pointLabels.length, d = this.pointLabels.length / 2, f = d / 2, g = f > a || a > u - f, m = a === f || a === u - f;
                                0 === a ? i.textAlign = "center" : a === d ? i.textAlign = "center" : d > a ? i.textAlign = "left" : i.textAlign = "right", m ? i.textBaseline = "middle" : g ? i.textBaseline = "bottom" : i.textBaseline = "top", i.fillText(this.pointLabels[a] ? this.pointLabels[a] : "", o.x, o.y)
                            }
                        }
                    }
                }
        ...
        a = "function" == typeof a ? a : window.moment, e.exports = function (t) {
            var e = t.helpers, i = {
                ...
                initialize: function () {
                    ...
                    this.ctx.save();
                    var s = e.getValueOrDefault(this.options.ticks.fontSize, t.defaults.global.defaultFontSize), o = e.getValueOrDefault(this.options.ticks.fontStyle, t.defaults.global.defaultFontStyle), n = e.getValueOrDefault(this.options.ticks.fontFamily, t.defaults.global.defaultFontFamily), r = e.fontString(s, o, n);
                    if (this.ctx.font = r, this.ticks = [], this.unitScale = 1, this.scaleSizeInUnits = 0, this.options.time.unit)this.tickUnit = this.options.time.unit || "day", this.displayFormat = this.options.time.displayFormats[this.tickUnit], this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0), this.unitScale = e.getValueOrDefault(this.options.time.unitStepSize, 1); else {
                        var l = this.isHorizontal() ? this.width - (this.paddingLeft + this.paddingRight) : this.height - (this.paddingTop + this.paddingBottom), h = this.tickFormatFunction(this.firstTick, 0, []), c = this.ctx.measureText(h).width, u = Math.cos(e.toRadians(this.options.ticks.maxRotation)), d = Math.sin(e.toRadians(this.options.ticks.maxRotation));
                        c = c * u + s * d;
                        var f = l / c;
                        ...
                        for (var g = 0, m = i.units[g]; g < i.units.length;) {
                            ...
                            ++g, m = i.units[g], this.tickUnit = m.name, this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0), this.displayFormat = this.options.time.displayFormats[m.name]
                        }
                    }
                    var b;
                    ...
                    for (var v = 1; v < this.scaleSizeInUnits; ++v) {
                        var x = b.clone().add(v, this.tickUnit);
                        if (this.options.time.max && x.diff(this.lastTick, this.tickUnit, !0) >= 0)break;
                        v % this.unitScale === 0 && this.ticks.push(x)
                    }
                    ...
                    if (s) {
                        var o = s.diff(this.firstTick, this.tickUnit, !0), n = o / this.scaleSizeInUnits;
                        if (this.isHorizontal()) {
                            var r = this.width - (this.paddingLeft + this.paddingRight), l = (r / Math.max(this.ticks.length - 1, 1), r * n + this.paddingLeft);
                            return this.left + Math.round(l)
                        }
                        var h = this.height - (this.paddingTop + this.paddingBottom), c = (h / Math.max(this.ticks.length - 1, 1), h * n + this.paddingTop);
