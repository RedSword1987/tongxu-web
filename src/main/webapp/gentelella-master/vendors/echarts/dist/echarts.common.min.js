!function (t, e) {
    ...
    return function (t) {
         ...
         */
        var m = i(112), v = i(78), y = i(28), x = i(113), _ = i(10), b = i(13), w = i(54), M = i(25), S = i(3), A = i(67), T = i(1), C = i(22), I = i(15), k = i(21), D = T.each, L = ["echarts", "chart", "component"], P = ["transform", "filter", "statistic"];
        ...
        var B = [], N = {}, V = [], F = {}, G = [], W = {}, Z = {}, H = {}, q = {}, j = new Date - 0, X = new Date - 0, U = "_echarts_instance_", Y = {
            version: "3.1.7",
        ...
        function n(t) {
            if (!t.__isHover) {
                if (t.__hoverStlDirty) {
                    var e = t.style.stroke, i = t.style.fill, n = t.__hoverStl, r = v.lift;
        ...
        var f = i(1), p = i(156), g = Math.round, m = i(6), v = i(22), y = i(19), x = i(5), _ = i(16), b = {};
        ...
        var a = i(35), s = i(1), l = i(27), h = i(137), c = i(16), u = Math.abs;
        o.prototype = {
        ...
        }), l.enableClassManagement(c, {registerWhenExtend: !0}), s.enableSubTypeDefaulter(c), s.enableTopologicalTravel(c, n), o.mixin(c, i(116)), t.exports = c
    }, function (t, e, i) {
        "use strict";
        ...
        var n = i(1), r = i(9), o = i(7), a = i(10), s = r.encodeHTML, l = r.addCommas, h = a.extend({
            ...
            formatTooltip: function (t, e) {
                var i = this._data, r = this.getRawValue(t), o = n.isArray(r) ? n.map(r, l).join(", ") : l(r), a = i.getName(t), h = i.getItemVisual(t, "color"), c = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;background-color:' + h + '"></span>';
        ...
        function s(t, e, i, r, o, a) {
            ...
            if (n(u) && n(d))if (n(l))a[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var T = (2 * u * l - 3 * s * d) / (2 * b(u * u * u)), C = Math.acos(T) / 3, I = b(u), k = Math.cos(C), g = (-l - 2 * I * k) / (3 * s), y = (-l + I * (k + S * Math.sin(C))) / (3 * s), D = (-l + I * (k - S * Math.sin(C))) / (3 * s);
        ...
        h.getScaleExtent = function (t, e) {
            ...
            var i = t.scale, n = h.getScaleExtent(t, e), r = null != (e.getMin ? e.getMin() : e.get("min")), o = null != (e.getMax ? e.getMax() : e.get("max"));
        ...
        var r = i(1), o = i(142), a = i(55), s = i(66);
        n.prototype = {
            constructor: n,
            type: "displayable",
            __dirty: !0,
        ...
        var h = i(14), c = i(31), u = i(1), d = i(7), f = i(28), p = d.getDataItemValue, g = d.converDataValue, m = {
            cartesian2d: function (t, e, i) {
                var n = i.getComponent("xAxis", e.get("xAxisIndex")), r = i.getComponent("yAxis", e.get("yAxisIndex")), o = n.get("type"), l = r.get("type"), h = [{
                    ...
                    type: s(o),
                    stackable: a(o)
                }, {name: "y", type: s(l), stackable: a(l)}], u = "category" === o;
                return c(h, t, ["x", "y", "z"]), {
                    dimensions: h,
                    categoryIndex: u ? 0 : 1,
        ...
        var o = i(1), a = i(15), s = i(2), l = i(7), h = i(167), c = o.each, u = l.eachAxisDim, d = s.extendComponentModel({
            type: "dataZoom",
        ...
        var r = i(35), o = i(8), a = i(1), s = i(60), l = i(140), h = new l(50);
        n.prototype = {
        ...
        c._updateCommon = function (t, e, i) {
            var r = this.childAt(0), o = t.hostModel, s = t.getItemModel(e), c = s.getModel(u), g = t.getItemVisual(e, "color"), m = r.style, v = s.getModel(d).getItemStyle();
                ...
                if (e.get("axisLabel.show")) {
                    ...
                    if ("category" !== o.type) {
                        ...
                        if (e.getMax ? e.getMax() : e.get("max")) {
                            var k = y[y.length - 1], D = y[y.length - 2];
                            t(D, k) && (k.ignore = !0)
                        }
                    }
                }
        ...
        var s = i(11), l = i(23), h = i(1), c = i(107), u = i(105), d = h.each, f = l.ifAxisCrossZero, p = l.niceScaleExtent;
        i(108);
        var g = o.prototype;
         ...
         */
        var r = i(58), o = i(15), a = i(127), s = i(130), l = i(131), h = !o.canvasSupported, c = {canvas: i(129)}, u = {}, d = {};
        ...
        var c = i(21), u = i(1), d = i(33), f = i(102);
        ...
        var c = i(24), u = i(5), d = i(162), f = i(3), p = i(1), g = i(4), m = h.prototype;
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                ...
                var D = g.getModel("textStyle").getFont(), L = g.get("rotate") ? 0 > b ? -_ + Math.PI : -_ : 0, P = t.getFormattedLabel(i, "normal") || l.getName(i), O = o.getBoundingRect(P, D, d, "top");
                c = !!L, f.label = {
                    x: n,
                    y: r,
                    position: m,
        ...
        var n = i(1), r = i(43), o = i(109), a = function (t, e, i, n, o) {
        ...
        var u = i(1), d = i(7), f = i(12), p = u.each, g = u.filter, m = u.map, v = u.isArray, y = u.indexOf, x = u.isObject, _ = i(10), b = i(114), w = "\x00_ec_inner", M = f.extend({
            constructor: M,
            init: function (t, e, i, n) {
        ...
        var a = i(1), s = i(121), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]], h = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"], c = ["bar", "boxplot", "candlestick", "chord", "effectScatter", "funnel", "gauge", "lines", "graph", "heatmap", "line", "map", "parallel", "pie", "radar", "sankey", "scatter", "treemap"], u = a.each;
        t.exports = function (t) {
        ...
        var u = i(15), d = i(33), f = i(1), p = i(155), g = i(139), m = i(21), v = ["click", "dblclick", "mousewheel", "mouseout"];
        ...
        var c = i(42), u = i(1), d = i(45), f = i(8), p = i(128), g = new f(0, 0, 0, 0), m = new f(0, 0, 0, 0), v = function (t, e, i) {
        ...
        var h = i(27).CMD, c = i(136), u = i(135), d = i(138), f = i(134), p = i(57).normalizeRadian, g = i(18), m = i(75), v = c.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var a = i(6), s = i(27), l = i(157), h = i(19), c = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], u = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
        ...
        var s = i(40), l = i(1), h = i(71), c = i(174), u = l.bind, d = s.extend({
        ...
        var n = i(39), r = (i(11), i(1), n.extend({
        ...
        var r = i(1), o = i(3), a = i(126), s = i(40), l = o.Rect, h = i(4), c = h.linearMap, u = i(11), d = i(71), f = h.asc, p = r.bind, g = Math.round, m = Math.max, v = r.each, y = 7, x = 1, _ = 30, b = "horizontal", w = "vertical", M = 5, S = ["line", "bar", "candlestick", "scatter"], A = s.extend({
            type: "dataZoom.slider",
            init: function (t, e) {
        ...
        var c = i(1), u = i(70), d = i(126), f = c.curry, p = "\x00_ec_dataZoom_roams", g = {
            register: function (t, e) {
        ...
        var a = i(1), s = i(24), l = i(3), h = i(103), c = a.curry, u = "#ccc";
                    ...
                    a.each(t.getData(), function (a) {
                        ...
                        if (!f[h])if (p) {
                            ...
                            if (!f[h] && e.legendDataProvider) {
                                var s = e.legendDataProvider(), l = s.indexOfName(h), p = s.getItemVisual(l, "color"), g = "roundRect", m = this._createItem(h, a, t, g, null, d, p, u);
        ...
        function r(t, e, i, n, r, o, a) {
            var s, l = o.coordinateSystem, h = t.getItemModel(e), u = h.get("x"), d = h.get("y");
            if (null != u && null != d)s = [c.parsePercent(u, a.getWidth()), c.parsePercent(d, a.getHeight())]; else {
        ...
        function o(t, e, i) {
            ...
            var o = new s(r, i), l = new s(r, i), h = new s([], i), c = a.map(i.get("data"), a.curry(g, e, t, i));
        ...
        var a = i(1), s = i(14), l = i(9), h = i(7), c = i(4), u = l.addCommas, d = l.encodeHTML, f = i(104), p = i(84), g = function (t, e, i, n) {
            var r = t.getData(), o = n.type;
            if (!a.isArray(n) && ("min" === o || "max" === o || "average" === o)) {
                var s = f.getAxisInfo(n, r, e, t), l = s.baseAxis.dim + "Axis", h = s.valueAxis.dim + "Axis", c = s.baseAxis.scale.getExtent(), u = a.clone(n), d = {};
            ...
            formatTooltip: function (t) {
                var e = this._data, i = this.getRawValue(t), n = a.isArray(i) ? a.map(i, u).join(", ") : u(i), r = e.getName(t);
        ...
        a.defaults(m, h.dataFormatMixin), i(2).extendComponentView({
            type: "markLine", init: function () {
                ...
                var l = t.coordinateSystem, h = t.name, c = t.getData(), u = this._markLineMap, d = u[h];
        ...
        var o = i(38), a = i(1), s = i(9), l = i(7), h = i(4), c = s.addCommas, u = s.encodeHTML, d = i(14), f = i(104), p = {
            getRawDataArray: function () {
                return this.option.data
            }, formatTooltip: function (t) {
        ...
        (function (e) {
            ...
            var r = i(29), o = i(1), a = i(3), s = i(12), l = i(52), h = i(103), c = i(17);
            t.exports = i(2).extendComponentView({
        ...
        var h = i(1), c = i(4), u = i(160), d = i(8), f = i(26), p = i(100), g = i(102), m = h.each, v = c.asc;
        i(175);
        ...
        var l = i(1), h = i(22), c = i(33), u = i(9), d = l.each, f = u.toCamelCase, p = ["", "-webkit-", "-moz-", "-o-"], g = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
        a.prototype = {
        ...
        var u = i(197), d = i(3), f = i(1), p = i(9), g = i(4), m = g.parsePercent, v = i(15);
        ...
        if (!i(15).canvasSupported) {
            var n = i(5), r = i(8), o = i(27).CMD, a = i(22), s = i(17), l = i(66), h = i(35), c = i(46), u = i(65), d = i(6), f = i(16), p = i(158), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", M = "progid:DXImageTransform.Microsoft", S = 21600, A = S / 2, T = 1e5, C = 1e3, I = function (t) {
                ...
                for (a = 0; a < t.length;) {
                    switch (r = t[a++], n = "", i = 0, r) {
                        ...
                        case c:
                            ...
                            break;
                        case d:
                            var k = 0, D = 0, L = 1, P = 1, O = 0;
                            e && (k = e[4], D = e[5], L = m(e[0] * e[0] + e[1] * e[1]), P = m(e[2] * e[2] + e[3] * e[3]), O = Math.atan2(-e[1] / P, e[0] / L));
                            var z = t[a++], E = t[a++], R = t[a++], B = t[a++], N = t[a++] + O, V = t[a++] + N + O;
                            a++;
                            var G = t[a++], W = z + y(N) * R, Z = E + x(N) * B, M = z + y(V) * R, T = E + x(V) * B, H = G ? " wa " : " at ";
            ...
            var Z, H = "normal", q = {}, j = 0, X = 100, U = document.createElement("div"), Y = function (t) {
                var e = q[t];
                if (!e) {
                    j > X && (j = 0, q = {});
                    var i, n = U.style;
