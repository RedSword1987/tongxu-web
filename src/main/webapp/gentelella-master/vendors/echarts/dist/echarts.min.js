!function (t, e) {
    ...
    return function (t) {
        ...
        }, z = Object.prototype.toString, R = Array.prototype, O = R.forEach, E = R.filter, V = R.slice, N = R.map, B = R.reduce, G = {
            inherits: c,
            mixin: d,
            clone: n,
            merge: a,
        ...
        function o(t, e, i) {
            ...
            var v, y = s && s.categoryAxisModel, x = "ordinal" === d[0].type ? 0 : "ordinal" === d[1].type ? 1 : -1, _ = new h(d, e), w = l(s, t), b = y && a(t) ? function (t, e, i, n) {
        ...
        u._updateCommon = function (t, e, i) {
            var a = this.childAt(0), o = t.hostModel, s = t.getItemModel(e), u = s.getModel(c), g = t.getItemVisual(e, "color"), m = a.style, v = s.getModel(d).getItemStyle();
        ...
        var p = {
            axisLine: function () {
                ...
                if (e.get("axisLabel.show")) {
                    var i = this.opt, o = e.axis, r = e.getModel("axisLabel"), h = r.getModel("textStyle"), u = r.get("margin"), c = o.scale.getTicks(), f = e.getFormattedLabels(), p = i.labelRotation;
                    ...
                    for (var m = a(i, p, i.labelDirection), v = e.get("data"), y = [], x = e.get("silent"), _ = 0; _ < c.length; _++)if (!g(o, _, i.labelInterval)) {
                        ...
                        var b = w.getTextColor(), M = o.dataToCoord(c[_]), S = [M, i.labelOffset + i.labelDirection * u], A = o.scale.getLabel(c[_]), I = new s.Text({
                            style: {
                                text: f[_],
                    ...
                    r.each(t.getData(), function (r) {
                        ...
                        if (!f[h])if (p) {
                            ...
                            if (!f[h] && e.legendDataProvider) {
                                var s = e.legendDataProvider(), l = s.indexOfName(h), p = s.getItemVisual(l, "color"), g = "roundRect", m = this._createItem(h, r, t, g, null, d, p, c);
                ...
                for (r = 0; r < t.length;) {
                    switch (a = t[r++], n = "", i = 0, a) {
                        ...
                        case d:
                            ...
                            r++;
                            var F = t[r++], W = R + y(N) * E, H = O + x(N) * V, M = R + y(B) * E, I = O + x(B) * V, Z = F ? " wa " : " at ";
            ...
            type: "treemap", init: function (t, e) {
                ...
                if (M) {
                    ...
                    if (!A || !A.length) {
                        ...
                        if (T) {
                            var C = Math.max(_ - 2 * I, 0), L = Math.max(w - 2 * I, 0), D = l.getModel("label.normal"), P = l.getModel("label.normal.textStyle"), k = l.getModel("itemStyle.emphasis").getItemStyle(), z = l.getModel().get("name"), R = P.getTextRect(z), O = D.get("show");
        ...
        var o = i(213), r = i(3), s = i(1), l = i(4), h = i(71), u = l.linearMap, c = i(76), d = i(214), f = s.each, p = o.extend({
            ...
            _createBarVisual: function (t, e, i, n) {
                ...
                }, o = this.getControllerVisual(t, "color", a), r = [this.getControllerVisual(t[0], "symbolSize", a), this.getControllerVisual(t[1], "symbolSize", a)], s = this._createBarPoints(i, r);
